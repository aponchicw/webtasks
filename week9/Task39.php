<html>
    ...
    <body>
        <div class="cards">
        <?php
        $cars = [["maker"=>"Toyota","model"=>"Carina","year"=>2001,"price"=>19999,"image"=>"https://a.d-cd.net/cea52es-480.jpg"],["maker"=>"Toyota","model"=>"Camry","year"=>2005,"price"=>30000,"image"=>"https://d1hu588lul0tna.cloudfront.net/toyotaone/ruru/002-camry-exclusive-next-steps_tcm-3020-870114.jpg"],["maker"=>"Audi","model"=>"A8","year"=>1986,"price"=>12000,"image"=>"http://www.theautohost.com/_contentPages/vehicleContentPages/audi/2017/A8%20L/images/2017-Audi-A8L-exterior-grille.jpg"],
            ...
            foreach($cars as $i)
                if($i['price'] >= 20000){
                    echo	'<div class="card">
                            ...
                            <div class="year">'.(2019-$i['year']).'years</div>
                            </div>
                            </div>';
                }
        }
        ...
        ?>
            ...
            <div class="menu">
                ...
                <a href="Task3.php?year=old">Old cars (More than 7 years)</a>|
                <a href="Task3.php?price=expensive">Expensive cars (more than 20.000$)</a>
            </div>
        </div>
    </body>
</html>
